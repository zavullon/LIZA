...
plt.plot(depths, all_rmse_train_tree, color="b", label="Decision tree - train")
plt.plot(depths, all_rmse_val_tree, color="g", label="Decision tree - validation")
plt.plot(depths, all_rmse_train_forest, color="y", label="Random Forest - train")
plt.plot(depths, all_rmse_val_forest, color="r", label="Random Forest - validation")                                                  
...
pred_test.shape
df_submit = export_ens(df_test, pred_test, True, r"C:\Users\lizao\Downloads\lab2\results/OrlovaE.csv")
...
pred_test = pred_test.reshape(-1,1)
pred_test.shape
df_submit = export_ens(df_test, pred_test, True, r"C:\Users\lizao\Downloads\lab2\results/xgb1.csv")
